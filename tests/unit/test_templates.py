...
class TestExtractPlaceholders:
    def test_finds_simple_placeholders(self):
        from apple_mail_fast_mcp.templates import extract_placeholders
...
class TestParseTemplateFile:
    def test_parses_subject_header_and_body(self):
        from apple_mail_fast_mcp.templates import parse_template_file
...
class TestSerializeTemplate:
    def test_with_subject(self):
        from apple_mail_fast_mcp.templates import Template, serialize_template
    ...
    def test_round_trip(self):
        from apple_mail_fast_mcp.templates import (
            Template,
            parse_template_file,
            serialize_template,
        )
...
class TestTemplateRender:
    def test_substitutes_placeholders(self):
        from apple_mail_fast_mcp.templates import Template
...
class TestTemplateStore:
    ...
    def _store(self, tmp_path: Path):
        from apple_mail_fast_mcp.templates import TemplateStore
